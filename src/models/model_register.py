...
if __name__ == "__main__":
    ...
    print(f"Model registered with URI: {model_registry_path}, Name: {model_name}")

    # get the model version
    registered_model_version = model_version.version
    registered_model_name = model_version.name
    print(f"Registered model version: {registered_model_version}, name: {registered_model_name}")
    ...
    print(f"Set model version tag: deployment_stage=staging for model {registered_model_name} version {registered_model_version}")
